...
public class Java1DArrayPt2{
    ...
    public static boolean isSolveable(int leap, int[] game, int index){
        ...
        game[index] = 1;  // making current array place in game 1 so that we can cross out a index
        
        // going through all posibilites of movement
        return isSolveable(leap, game, index + leap) || 
            isSolveable(leap, game, index + 1) ||
            isSolveable(leap, game, index - 1);
    }
